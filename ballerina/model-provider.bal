...
# Supports both the Chat Completions API and the Responses API, selected via the `apiType` configuration.
public isolated distinct client class ModelProvider {
    *ai:ModelProvider;
    ...
    # + apiType - The OpenAI API endpoint to use; either the Responses API (default) or the Chat Completions API
